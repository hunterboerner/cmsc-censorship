...
\title{Files, Friction, and Firewalls}

\author{ Theron Boerner \\
(theron@uchicago.edu) \\
Gabriel Zhang \\
(jiayuanz@uchicago.edu)\\
Liam Wright\\
(liamw@uchicago.edu)}
...
Censors can block access to data. The data type with the most workarounds are
object stores. \emph{TODO} We need examples of files being blocked.
